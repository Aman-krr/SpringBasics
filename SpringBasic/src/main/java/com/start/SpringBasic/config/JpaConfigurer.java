package com.start.SpringBasic.config;
...
import com.start.SpringBasic.support.jpa.CustomRepositoryFactoryBean;
import com.start.SpringBasic.support.jpa.SpringSecurityAuditorAware;
import com.start.SpringBasic.web.entity.User;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.start.SpringBasic.web.repository", repositoryFactoryBeanClass = CustomRepositoryFactoryBean.class)
// @EnableJpaRepositories(basePackages =
// "com.start.SpringBasic.web.repository",
